...
export const translations: Translations = {
  dari: {
    ...
    users: 'کاربران', shop_users: 'کاربران فروشگاه', debts: 'قرضداران', notifications: 'اعلان‌ها',
    ...
    sync: 'همگام‌سازی', pending_sales: 'تأیید فعالیت',
    pending_activity_hint: 'فروش، انتقال انبار، مصارف و صندوق، واپسی و لیست خرید تا تأیید مدیر اینجاست؛ پس از تأیید در گزارش‌ها و موجودی اعمال می‌شود.',
    ...
    theme_light: 'تم روشن', theme_dark: 'تم تاریک',
    ...
    overdue_debts: 'قرضداران معوق', sales_expense_chart: 'نمودار فروش و هزینه',
    ...
    contact: 'تماس', auto_debt_reminder: 'یادآوری خودکار قرض',
    days_before_due: 'چند روز قبل از سررسید', register_customer: 'ثبت مشتری',
    customer_history: 'سوابق خرید', invoice_count: 'تعداد فاکتور', active_debt: 'قرضدار فعال',
    settled: 'تسویه', invoices_history: 'سوابق فاکتورها', no_invoices: 'هیچ فاکتوری ثبت نشده',
    items: 'قلم', remaining: 'مانده', active_debts: 'قرضداران فعال', due_date: 'سررسید',
    ...
    select_customer: 'جستجو یا انتخاب مشتری...', existing_debt: 'قرض موجود',
    ...
    total_amount: 'مبلغ کل', change_return: 'باقی برگشت', credit_debt: 'قرض نسیه',
    ...
    // Debts extra
    manage_debts: 'مدیریت قرضداران', active_debt_count: 'قرضدار فعال', total_debt: 'کل قرض',
    ...
    no_debts_found: 'قرضداری یافت نشد',
    // Suppliers
    ...
    // Reports
    sales_report: 'گزارش فروش', inventory_report: 'گزارش موجودی', debt_report: 'گزارش قرضداران',
  ...
  pashto: {
    ...
    sync: 'همغږي', pending_sales: 'د فعالیت تایید',
    pending_activity_hint: 'پلور، د انبار لیږد، لګښت او صندوق، بیرته ورګرځونه او د پیرود لیست تر د مدیر تاییده دلته ښکاري.',
    ...
    theme_light: 'روښانه تم', theme_dark: 'تیاره تم',
  ...
  english: {
    ...
    sync: 'Sync', pending_sales: 'Activity approval',
    pending_activity_hint: 'Sales, stock moves, expenses, cashbox, returns and purchase lists appear here until the shop admin approves; then they flow into reports and inventory.',
...
export const mockBusinessTypes: BusinessType[] = [
  { id: 1, name: 'فروشگاه عمومی', code: 'supermarket', icon: '🏪', is_active: true, features: ['expiry', 'stock', 'wholesale'] },
  ...
  { id: 9, name: 'کتابفروشی', code: 'bookstore', icon: '📚', is_active: true, features: ['stock', 'isbn', 'publisher'] },
];
